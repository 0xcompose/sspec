...
contract TestVaultWhenPPSDrops is MaatVaultTestSetup {
    ...
    function test_deposit_afterPPSDrop() public {
        ...
        uint256 shares = maatVault.deposit(amount, address(this));
    ...
    function test_withdraw_afterPPSDrop() public {
        ...
        maatVault.approve(address(maatVault), type(uint256).max);
        ...
        uint256 assetsWithdrawable = maatVault.convertToAssetsByLowerPPS(shares);
    ...
    function test_redeem_afterPPSDrop() public {
        ...
        uint256 assets = maatVault.redeem(shares, address(this), address(this));
