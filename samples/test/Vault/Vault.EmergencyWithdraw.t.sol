...
contract VaultEmergencyWithdrawalTest is MaatVaultTestSetup {
    ...
    function _afterSetUp() internal override {
        ...
        maatVault.depositInStrategy(
            strategyId, maatVault.idle(), bytes32("intentionId")
        );
        vm.stopPrank();
    }
    ...
    function test_EmergencyWithdraw_EarlyWithdrawal() public {
        ...
        bytes32 intentionId = maatVault.requestWithdraw(
            initialBalanceShares / 2, maatVault.chainEid(), owner, receiver
        );
        ...
        )
    {
        ...
        amountOutTokens =
            maatVault.convertToAssetsByLowerPPS(_sharesWithdrawRequest);
    ...
    function _emergencyWithdraw_template(
        ...
        bytes32 intentionId = maatVault.requestWithdraw(
            _sharesWithdrawRequest, _chainEidToWithdraw, _owner, _receiver
        );
