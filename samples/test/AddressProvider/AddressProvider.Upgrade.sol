...
import {
    MaatAddressProviderTestSetup,
    MaatAddressProviderV1
} from "./_AddressProvider.Setup.sol";

contract AddressProviderSettersFuncTesting is MaatAddressProviderTestSetup {
    function test_Upgrade() public {
        MaatAddressProviderUpgrade newImplementation =
            new MaatAddressProviderUpgrade();
        ...
        assertEq(
            MaatAddressProviderUpgrade(address(maatAddressProvider)).newVariable(
            ),
            "new"
        );
        assertEq(
